    ...
    <div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          {!named ? (
            ...
            >
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">如果你的島嶼有一個名字，它會是什麼？</h2>
              <p className="text-white/70 mb-6">為你的島嶼命名，我們會開始為你記錄專屬的島主體驗。</p>
            ...
            >
              <p className="text-[#B8902F] font-medium mb-1 tracking-widest uppercase text-sm">歡迎回來，島主</p>
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">{savedIsland} 島已為你保留</h2>
              <p className="text-white/80 mb-4">讓我們開始設計你的島主生活。</p>
      ...
      <section className="py-20 px-4 bg-[#f8fafb]">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <p className="text-[#B8902F] font-medium mb-2">你的島主團隊</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { title: '島主關係經理', desc: '一對一陪伴你，從第一次體驗到決定是否留下來' },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-24 px-4 bg-[#f8fafb]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[#2ec4b6] font-medium mb-2">精選島嶼</p>
            <h2 className="text-4xl md:text-5xl font-bold text-[#0d1b2a] mb-4">選擇你的島嶼</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">先住進來，感受這個地方如何回應你。島嶼會告訴你答案。</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">《成為島主的 7 種生活方式》</h2>
      ...
      <section className="py-24 px-4 bg-[#f8fafb]">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <p className="text-[#B8902F] font-medium mb-2">島主故事</p>
            <h2 className="text-3xl md:text-4xl font-bold text-[#0d1b2a]">他們本來只想度假，後來決定留下來</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
      ...
      <section className="py-6 px-4 bg-[#B8902F]">
        <div className="max-w-6xl mx-auto text-center text-white">
          <p className="text-sm md:text-base font-medium">
            這一季，<span className="font-bold text-lg">{savedIsland || '你的島嶼'}</span> 還在名單上 — 
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center text-white">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">{savedIsland ? `${savedIsland} 島在等你` : '你的島嶼在等你'}</h2>
          <p className="text-lg text-white/80 mb-8">先以島主的身份住進來。感覺對了，一切才會開始。所有價格以港幣結算，支援本地支付方式。</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
