      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/20">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            ...
            />
            <span className="font-semibold text-[#0a4c6b] text-lg">HK Maldivers</span>
          </Link>
      ...
      <footer className="bg-[#0d1b2a] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">HK Maldivers</h3>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-400">
                ...
                <p>Email: hello@hkmaldivers.com</p>
                <p>營業時間: 週一至週六 10:00-19:00</p>
              </div>
            </div>
          </div>
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-500">
            <p>© 2026 HK Maldivers. All rights reserved. 所有價格以港幣 (HKD) 結算。</p>
          </div>
        </div>
      </footer>
    </div>
